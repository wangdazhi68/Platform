        ...
        <div class="content">
            ...
            <div class="cnt">
                ...
                <div class="parpers_cnt">
                    <div class="info_top">
                        <p class="ico-wrap"><img src="../../assets/images/checktj.png" alt=""></p>
                        <p class="bold">您的实名认证资料已提交完成，请使用对公账户向以下账户打款完成验证</p>
                        <p class="thin">完成打款后，请耐心等待审核结果（审核时间以银行到账时间为准，一般1~3个工作日）</p>
                    </div>
                    <div class="table">
                        <dl>
                            <dt>收款方开户行</dt>
                        ...
                        <dl>
                            <dt>收款方账户名称</dt>
                            <dd>北京联合信任技术服务有限公司</dd>
                        </dl>
                        <dl>
                            <dt>收款方账号</dt>
                            <dd>3211 0010 0100 0337 04</dd>
                        </dl>
                    </div>
                    <div class="submit">
                        <span @click="kefu()">联系客服</span>
                        <b @click="cancel()">取消认证</b>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        kefu(){
            this.$layer.alert("客服电话: 010-58679288")   
        },
        cancel(){
            let that=this;
            this.$request({
                ...
                console.log(res);
                if(res.data.code==0){
                    that.$layer.msg('取消认证成功',{shade: true,time: 3})
                    setTimeout(function(){
                        that.$router.replace({path:'/authentication/index'})
                    },3000);
                }else{
                    that.$layer.msg('取消认证失败，请重试',{shade: true,time: 3})
                }
            }).catch((err) => {
                console.log(err);
            })
